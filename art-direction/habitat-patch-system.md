...
> A single softly rounded square Habitat Arcadia civic fabric badge, centered and fully visible in a square 1:1 reference image. Its fixed family frame has one continuous oxidized Mars-red outer border, a basalt-navy inner containment field, and one dust-cream stitch ring with dust-cream edge details. The center contains one clear teal water-droplet shape whose upper edge transitions into one pale ice-blue six-point crystal while its lower edge shelters exactly one deep algae-green leaf above one simple clay-brown terraced basin. The transition is graphic and stitched, not photoreal. Every part of the central motif is made from flat thread-filled embroidery and woven applique integrated into the badge: dense visible stitches fill the droplet, crystal, leaf, and basin; thick satin-stitch outlines and matte thread replace smooth surfaces, highlights, bevels, or three-dimensional icon shapes. The white belongs only to the external background, never to the inner patch field. The balanced motif is experimental, ecological, and legible at badge size, conveying practical stewardship of water, ice, and food systems. Tactile embroidery, woven cloth, slightly uneven practical stitching, softened thread, and restrained use marks make it a useful field-issued civic patch rather than a decorative logo. It is isolated front-on against a seamless uniform pure-white background under soft even diffuse light, with only a faint tight grounding shadow directly beneath the edge. No landscape scene, produce basket, clothing, hands, packaging, or recognizable text appears.

**Append to shared negative prompt**

> recycling logo, environmental NGO logo, planet Earth, globe, forest landscape, farm landscape, mountain scene, snowflake pattern covering badge, multiple leaves, multiple droplets, fruit, vegetables, wheat sheaf, photoreal water, glossy droplet, glossy icon, smooth vector logo, enamel badge, plastic applique, gel droplet, glass droplet, jewel, three-dimensional logo, 3D render, beveled icon, raised plastic symbol, smooth highlight, white inner panel, white central field, paper badge, cardboard badge
